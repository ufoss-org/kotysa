...
abstract class CoroutinesSelectBigDecimalAsNumericRepository<T : BigDecimalAsNumerics>(
    ...
    suspend fun insert() {
        sqlClient.insert(bigDecimalAsNumericWithNullable, bigDecimalAsNumericWithoutNullable)
    }
