...
class CoroutinesGenericAllTypesRepository(private val sqlClient: CoroutinesSqlClient) : Repository {
    ...
    override fun delete() = runBlocking<Unit> {
        ...
        sqlClient deleteAllFrom GenericAllTypesNullables
        sqlClient deleteAllFrom GenericAllTypesNullableDefaultValues
    }
    ...
    private suspend fun insertAllTypes() {
        ...
        sqlClient.insert(genericAllTypesNullable)
        sqlClient.insert(genericAllTypesNullableDefaultValue)
    }
    ...
    suspend fun insertAndReturnAllTypesDefaultValues() = sqlClient insertAndReturn genericAllTypesNullableDefaultValueToInsert
}