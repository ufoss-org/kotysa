...
interface CoroutinesSelectBooleanTest<T : Roles, U : Users, V : UserRoles, W : Companies,
        X : CoroutinesSelectBooleanRepository<T, U, V, W>, Y : Transaction> : CoroutinesRepositoryTest<X, Y> {
