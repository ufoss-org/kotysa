...
class JdbcSelectOrOracleTest : AbstractJdbcOracleTest<UserRepositoryJdbcOracleSelectOr>(),
    SelectOrTest<OracleRoles, OracleUsers, OracleUserRoles, UserRepositoryJdbcOracleSelectOr, JdbcTransaction> {
...
class UserRepositoryJdbcOracleSelectOr(sqlClient: JdbcSqlClient) :
    SelectOrRepository<OracleRoles, OracleUsers, OracleUserRoles>(sqlClient, OracleRoles, OracleUsers, OracleUserRoles)
