...
class JdbcSubQueryOracleTest : AbstractJdbcOracleTest<UserRepositoryJdbcOracleSubQuery>(),
    SubQueryTest<OracleRoles, OracleUsers, OracleUserRoles, UserRepositoryJdbcOracleSubQuery, JdbcTransaction> {
...
class UserRepositoryJdbcOracleSubQuery(sqlClient: JdbcSqlClient) :
    SubQueryRepository<OracleRoles, OracleUsers, OracleUserRoles>(sqlClient, OracleRoles, OracleUsers, OracleUserRoles)
