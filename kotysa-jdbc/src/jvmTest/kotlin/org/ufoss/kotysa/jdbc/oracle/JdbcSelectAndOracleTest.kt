...
class JdbcSelectAndOracleTest : AbstractJdbcOracleTest<UserRepositoryJdbcOracleSelectAnd>(),
    SelectAndTest<OracleRoles, OracleUsers, OracleUserRoles, UserRepositoryJdbcOracleSelectAnd, JdbcTransaction> {
...
class UserRepositoryJdbcOracleSelectAnd(sqlClient: JdbcSqlClient) :
    SelectAndRepository<OracleRoles, OracleUsers, OracleUserRoles>(sqlClient, OracleRoles, OracleUsers, OracleUserRoles)
