...
class JdbcSelectBooleanOracleTest : AbstractJdbcOracleTest<UserRepositoryJdbcOracleSelectBoolean>(),
    SelectBooleanTest<OracleRoles, OracleUsers, OracleUserRoles, UserRepositoryJdbcOracleSelectBoolean, JdbcTransaction> {
...
class UserRepositoryJdbcOracleSelectBoolean(sqlClient: JdbcSqlClient) :
    SelectBooleanRepository<OracleRoles, OracleUsers, OracleUserRoles>(sqlClient, OracleRoles, OracleUsers, OracleUserRoles)
