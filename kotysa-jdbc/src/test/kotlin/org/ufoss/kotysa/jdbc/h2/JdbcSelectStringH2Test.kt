...
class JdbcSelectStringH2Test : AbstractJdbcH2Test<UserRepositoryJdbcH2SelectString>(),
    SelectStringTest<H2Roles, H2Users, H2UserRoles, UserRepositoryJdbcH2SelectString, JdbcTransaction> {
...
class UserRepositoryJdbcH2SelectString(sqlClient: JdbcSqlClient) :
    SelectStringRepository<H2Roles, H2Users, H2UserRoles>(sqlClient, H2Roles, H2Users, H2UserRoles)
