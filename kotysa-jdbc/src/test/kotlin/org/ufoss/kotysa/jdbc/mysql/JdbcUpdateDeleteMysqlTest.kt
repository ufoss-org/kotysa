...
class JdbcUpdateDeleteMysqlTest : AbstractJdbcMysqlTest<UserRepositoryJdbcMysqlUpdateDelete>(),
    UpdateDeleteTest<MysqlRoles, MysqlUsers, MysqlUserRoles, UserRepositoryJdbcMysqlUpdateDelete, JdbcTransaction> {
...
class UserRepositoryJdbcMysqlUpdateDelete(sqlClient: JdbcSqlClient) :
    UpdateDeleteRepository<MysqlRoles, MysqlUsers, MysqlUserRoles>(sqlClient, MysqlRoles, MysqlUsers, MysqlUserRoles)
