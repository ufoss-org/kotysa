...
class KotlinxLocalDateRepositoryPostgresqlSelect(private val sqlClient: JdbcSqlClient) : Repository {
    ...
    private fun deleteAll() = sqlClient deleteAllFrom POSTGRESQL_KOTLINX_LOCAL_DATE
