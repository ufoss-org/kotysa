...
class JdbcAllTypesOracleTest : AbstractJdbcOracleTest<AllTypesRepositoryOracle>() {
    override fun instantiateRepository(sqlClient: JdbcSqlClient) = AllTypesRepositoryOracle(sqlClient)
...
class AllTypesRepositoryOracle(private val sqlClient: JdbcSqlClient) : Repository {
