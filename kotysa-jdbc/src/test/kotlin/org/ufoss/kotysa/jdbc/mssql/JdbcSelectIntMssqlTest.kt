...
class JdbcSelectIntMssqlTest : AbstractJdbcMssqlTest<IntRepositoryMssqlSelect>() {
    override fun instantiateRepository(sqlClient: JdbcSqlClient) = IntRepositoryMssqlSelect(sqlClient)
...
class IntRepositoryMssqlSelect(private val sqlClient: JdbcSqlClient) : Repository {
