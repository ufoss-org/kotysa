...
class JdbcUpdateDeleteOracleTest : AbstractJdbcOracleTest<UserRepositoryJdbcOracleUpdateDelete>(),
    UpdateDeleteTest<OracleRoles, OracleUsers, OracleUserRoles, UserRepositoryJdbcOracleUpdateDelete, JdbcTransaction> {
...
class UserRepositoryJdbcOracleUpdateDelete(sqlClient: JdbcSqlClient) :
    UpdateDeleteRepository<OracleRoles, OracleUsers, OracleUserRoles>(sqlClient, OracleRoles, OracleUsers, OracleUserRoles)
