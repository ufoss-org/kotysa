...
class SpringJdbcSelectStringAsLongTextMariadbTest : AbstractSpringJdbcMariadbTest<StringAsLongTextRepositoryMariadbSelect>() {
...
class StringAsLongTextRepositoryMariadbSelect(client: JdbcOperations) : Repository {
