...
class SpringJdbcSelectStringAsMediumTextMysqlTest : AbstractSpringJdbcMysqlTest<StringAsMediumTextRepositoryMysqlSelect>() {
...
class StringAsMediumTextRepositoryMysqlSelect(client: JdbcOperations) : Repository {
