...
class SpringJdbcSelectLongMariadbTest : AbstractSpringJdbcMariadbTest<LongRepositoryMariadbSelect>() {
...
class LongRepositoryMariadbSelect(client: JdbcOperations) : Repository {
