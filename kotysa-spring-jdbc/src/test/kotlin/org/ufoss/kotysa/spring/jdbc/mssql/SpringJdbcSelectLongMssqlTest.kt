...
class SpringJdbcSelectLongMssqlTest : AbstractSpringJdbcMssqlTest<LongRepositoryMssqlSelect>() {
...
class LongRepositoryMssqlSelect(client: JdbcOperations) : Repository {
