...
class SpringJdbcSelectStringAsTextPostgresqlTest : AbstractSpringJdbcPostgresqlTest<StringAsTextRepositoryPostgresqlSelect>() {
...
class StringAsTextRepositoryPostgresqlSelect(client: JdbcOperations) : Repository {
