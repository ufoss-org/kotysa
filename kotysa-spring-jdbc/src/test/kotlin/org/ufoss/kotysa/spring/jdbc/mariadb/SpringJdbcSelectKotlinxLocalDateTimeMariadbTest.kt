...
class SpringJdbcSelectKotlinxLocalDateTimeMariadbTest : AbstractSpringJdbcMariadbTest<KotlinxLocalDateTimeRepositoryMariadbSelect>() {
...
class KotlinxLocalDateTimeRepositoryMariadbSelect(client: JdbcOperations) : Repository {
