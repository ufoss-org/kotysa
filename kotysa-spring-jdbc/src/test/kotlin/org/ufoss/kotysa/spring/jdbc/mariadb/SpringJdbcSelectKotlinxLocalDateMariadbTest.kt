...
class SpringJdbcSelectKotlinxLocalDateMariadbTest : AbstractSpringJdbcMariadbTest<KotlinxLocalDateRepositoryMariadbSelect>() {
...
class KotlinxLocalDateRepositoryMariadbSelect(client: JdbcOperations) : Repository {
