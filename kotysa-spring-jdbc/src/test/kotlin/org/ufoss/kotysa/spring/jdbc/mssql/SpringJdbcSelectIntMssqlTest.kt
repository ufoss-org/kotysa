...
@Order(1)
class SpringJdbcSelectIntMssqlTest : AbstractSpringJdbcMssqlTest<IntRepositoryMssqlSelect>() {
...
class IntRepositoryMssqlSelect(client: JdbcOperations) : Repository {
