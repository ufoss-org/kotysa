...
class SpringJdbcSelectOffsetDateTimeMysqlTest : AbstractSpringJdbcMysqlTest<OffsetDateTimeRepositoryMysqlSelect>() {
...
class OffsetDateTimeRepositoryMysqlSelect(client: JdbcOperations) : Repository {
