...
class SpringJdbcSelectStringAsTinyTextMariadbTest : AbstractSpringJdbcMariadbTest<StringAsTinyTextRepositoryMariadbSelect>() {
...
class StringAsTinyTextRepositoryMariadbSelect(client: JdbcOperations) : Repository {
    ...
    private fun deleteAll() = sqlClient deleteAllFrom MARIADB_TINY_TEXT
