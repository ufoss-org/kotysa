...
class VertxSqlClientSelectStringMysqlTest :
    AbstractVertxSqlClientMysqlTest<UserRepositoryMysqlSelectString>() {

    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = UserRepositoryMysqlSelectString(sqlClient)
...
class UserRepositoryMysqlSelectString(sqlClient: MutinyVertxSqlClient) : AbstractUserRepositoryMysql(sqlClient) {
