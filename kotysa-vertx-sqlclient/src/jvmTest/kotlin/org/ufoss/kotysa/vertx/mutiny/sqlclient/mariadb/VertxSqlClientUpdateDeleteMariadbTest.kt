...
class VertxSqlClientUpdateDeleteMariadbTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryMariadbUpdateDelete(sqlClient)
...
class UserRepositoryMariadbUpdateDelete(sqlClient: VertxSqlClient) : AbstractUserRepositoryMariadb(sqlClient) {
