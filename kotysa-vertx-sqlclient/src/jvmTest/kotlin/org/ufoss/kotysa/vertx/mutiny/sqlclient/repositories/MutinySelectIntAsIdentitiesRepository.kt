...
import org.ufoss.kotysa.test.intAsIdentityWithNullable
import org.ufoss.kotysa.test.intAsIdentityWithoutNullable
...
abstract class MutinySelectIntAsIdentitiesRepository<T : IntAsIdentities>(
    ...
    fun insert() = sqlClient.insert(intAsIdentityWithNullable, intAsIdentityWithoutNullable)
