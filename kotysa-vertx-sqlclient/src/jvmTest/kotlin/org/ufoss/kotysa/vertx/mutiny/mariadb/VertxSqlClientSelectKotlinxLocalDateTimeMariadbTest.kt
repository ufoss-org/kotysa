...
class VertxSqlClientSelectKotlinxLocalDateTimeMariadbTest :
    AbstractVertxSqlClientMariadbTest<KotlinxLocalDateTimeRepositoryMariadbSelect>() {
...
class KotlinxLocalDateTimeRepositoryMariadbSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MariadbKotlinxLocalDateTimes
