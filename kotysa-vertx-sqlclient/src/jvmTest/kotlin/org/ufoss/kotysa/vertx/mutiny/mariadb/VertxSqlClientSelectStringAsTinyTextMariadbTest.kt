...
class VertxSqlClientSelectStringAsTinyTextMariadbTest : AbstractVertxSqlClientMariadbTest<StringAsTinyTextRepositoryMariadbSelect>() {
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = StringAsTinyTextRepositoryMariadbSelect(sqlClient)
...
class StringAsTinyTextRepositoryMariadbSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MariadbTinyTexts
