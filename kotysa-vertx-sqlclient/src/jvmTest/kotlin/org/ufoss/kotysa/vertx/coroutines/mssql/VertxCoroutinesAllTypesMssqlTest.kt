...
class VertxCoroutinesAllTypesMssqlTest : AbstractVertxCoroutinesMssqlTest<AllTypesRepositoryMssql>() {
    override fun instantiateRepository(sqlClient: CoroutinesVertxSqlClient) = AllTypesRepositoryMssql(sqlClient)
...
class AllTypesRepositoryMssql(private val sqlClient: CoroutinesVertxSqlClient) : Repository {
