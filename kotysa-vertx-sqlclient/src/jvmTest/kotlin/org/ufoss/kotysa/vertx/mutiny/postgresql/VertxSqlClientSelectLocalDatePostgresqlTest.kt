...
class VertxSqlClientSelectLocalDatePostgresqlTest :
    ...
    override fun instantiateRepository(sqlClient: PostgresqlMutinyVertxSqlClient) = LocalDateRepositoryPostgresqlSelect(sqlClient)
...
class LocalDateRepositoryPostgresqlSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists PostgresqlLocalDates
