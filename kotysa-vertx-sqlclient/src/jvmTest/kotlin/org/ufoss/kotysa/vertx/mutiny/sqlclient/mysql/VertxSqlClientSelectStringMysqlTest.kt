...
class VertxSqlClientSelectStringMysqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryMysqlSelectString(sqlClient)
...
class UserRepositoryMysqlSelectString(sqlClient: VertxSqlClient) : AbstractUserRepositoryMysql(sqlClient) {
