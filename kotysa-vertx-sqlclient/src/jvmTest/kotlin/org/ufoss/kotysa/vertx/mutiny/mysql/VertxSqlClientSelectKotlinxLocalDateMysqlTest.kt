...
class VertxSqlClientSelectKotlinxLocalDateMysqlTest :
    AbstractVertxSqlClientMysqlTest<KotlinxLocalDateRepositoryMysqlSelect>() {
...
class KotlinxLocalDateRepositoryMysqlSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MysqlKotlinxLocalDates
