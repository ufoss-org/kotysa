...
class VertxSqlClientSelectAliasPostgresqlTest : AbstractVertxSqlClientPostgresqlTest<UserRepositorySelectAlias>() {
    ...
    override fun instantiateRepository(sqlClient: PostgresqlMutinyVertxSqlClient) = UserRepositorySelectAlias(sqlClient)
...
class UserRepositorySelectAlias(sqlClient: MutinyVertxSqlClient) : AbstractUserRepositoryPostgresql(sqlClient) {
