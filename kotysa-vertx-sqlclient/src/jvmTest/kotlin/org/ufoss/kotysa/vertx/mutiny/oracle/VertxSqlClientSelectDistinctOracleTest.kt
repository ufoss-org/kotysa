...
class VertxSqlClientSelectDistinctOracleTest :
    ...
    MutinySelectDistinctTest<OracleRoles, OracleUsers, OracleUserRoles, OracleCompanies,
            UserRepositoryVertxSqlClientOracleSelectDistinct> {
...
class UserRepositoryVertxSqlClientOracleSelectDistinct(sqlClient: MutinyVertxSqlClient) :
    MutinySelectDistinctRepository<OracleRoles, OracleUsers, OracleUserRoles, OracleCompanies>(
        sqlClient,
        OracleRoles,
        OracleUsers,
        OracleUserRoles,
