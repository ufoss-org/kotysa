...
class VertxSqlClientSelectOrderByMariadbTest :
    ...
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = OrderByRepositoryMariadbSelect(sqlClient)
...
class OrderByRepositoryMariadbSelect(sqlClient: MutinyVertxSqlClient) : AbstractCustomerRepositoryMariadb(sqlClient) {
