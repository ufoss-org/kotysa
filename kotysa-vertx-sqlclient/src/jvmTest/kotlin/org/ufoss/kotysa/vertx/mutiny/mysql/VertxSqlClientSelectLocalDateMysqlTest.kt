...
class VertxSqlClientSelectLocalDateMysqlTest :
    AbstractVertxSqlClientMysqlTest<LocalDateRepositoryMysqlSelect>() {

    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = LocalDateRepositoryMysqlSelect(sqlClient)
...
class LocalDateRepositoryMysqlSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MysqlLocalDates
