...
interface MutinySelectLocalDateTimeAsTimestampTest<T : LocalDateTimeAsTimestamps,
        U : MutinySelectLocalDateTimeAsTimestampRepository<T>> : MutinyRepositoryTest<U> {
