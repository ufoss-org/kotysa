...
class VertxSqlClientSelectLocalDateMariadbTest :
    AbstractVertxSqlClientMariadbTest<LocalDateRepositoryMariadbSelect>() {

    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = LocalDateRepositoryMariadbSelect(sqlClient)
...
class LocalDateRepositoryMariadbSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MariadbLocalDates
