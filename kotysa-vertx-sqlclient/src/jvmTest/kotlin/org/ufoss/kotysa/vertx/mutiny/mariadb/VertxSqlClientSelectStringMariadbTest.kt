...
class VertxSqlClientSelectStringMariadbTest :
    AbstractVertxSqlClientMariadbTest<UserRepositoryMariadbSelectString>() {

    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = UserRepositoryMariadbSelectString(sqlClient)
...
class UserRepositoryMariadbSelectString(sqlClient: MutinyVertxSqlClient) : AbstractUserRepositoryMariadb(sqlClient) {
