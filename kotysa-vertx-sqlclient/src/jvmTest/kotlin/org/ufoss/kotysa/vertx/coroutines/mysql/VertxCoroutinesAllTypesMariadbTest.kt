...
class VertxCoroutinesAllTypesMysqlTest : AbstractVertxCoroutinesMysqlTest<AllTypesRepositoryMysql>() {
    override fun instantiateRepository(sqlClient: CoroutinesVertxSqlClient) = AllTypesRepositoryMysql(sqlClient)
...
class AllTypesRepositoryMysql(private val sqlClient: CoroutinesVertxSqlClient) : Repository {
