...
class VertxSqlClientInheritanceMariadbTest : AbstractVertxSqlClientMariadbTest<InheritanceMariadbRepository>() {
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = InheritanceMariadbRepository(sqlClient)
...
class InheritanceMariadbRepository(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTable() = sqlClient createTableIfNotExists MariadbInheriteds
