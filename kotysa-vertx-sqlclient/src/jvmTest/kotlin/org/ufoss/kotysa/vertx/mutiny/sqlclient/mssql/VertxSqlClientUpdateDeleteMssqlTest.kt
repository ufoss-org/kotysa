...
class VertxSqlClientUpdateDeleteMssqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryMssqlUpdateDelete(sqlClient)
...
class UserRepositoryMssqlUpdateDelete(sqlClient: VertxSqlClient) : AbstractUserRepositoryMssql(sqlClient) {
