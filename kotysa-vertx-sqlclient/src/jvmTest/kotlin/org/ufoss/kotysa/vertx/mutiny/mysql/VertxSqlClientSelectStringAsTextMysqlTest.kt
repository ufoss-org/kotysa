...
class VertxSqlClientSelectStringAsTextMysqlTest :
    AbstractVertxSqlClientMysqlTest<UserRepositoryMysqlSelectStringAsText>() {
...
class UserRepositoryMysqlSelectStringAsText(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MysqlTexts
