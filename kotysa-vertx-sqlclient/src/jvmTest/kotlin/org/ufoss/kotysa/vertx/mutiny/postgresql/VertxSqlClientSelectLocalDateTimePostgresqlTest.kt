...
class VertxSqlClientSelectLocalDateTimePostgresqlTest :
    ...
    override fun instantiateRepository(sqlClient: PostgresqlMutinyVertxSqlClient) = LocalDateTimeRepositoryPostgresqlSelect(sqlClient)
...
class LocalDateTimeRepositoryPostgresqlSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists PostgresqlLocalDateTimeAsTimestamps
