...
class VertxSqlClientSelectLocalDateTimeMariadbTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = LocalDateTimeRepositoryMariadbSelect(sqlClient)
...
class LocalDateTimeRepositoryMariadbSelect(private val sqlClient: VertxSqlClient) : Repository {
