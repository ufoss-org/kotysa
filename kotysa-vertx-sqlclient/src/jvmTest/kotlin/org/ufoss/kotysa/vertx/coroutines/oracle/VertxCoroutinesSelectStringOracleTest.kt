...
class VertxCoroutinesSelectStringOracleTest : AbstractVertxCoroutinesOracleTest<UserRepositoryJdbcOracleSelectString>(),
    CoroutinesSelectStringTest<OracleRoles, OracleUsers, OracleUserRoles, UserRepositoryJdbcOracleSelectString,
            Transaction> {
    override fun instantiateRepository(sqlClient: CoroutinesVertxSqlClient) = UserRepositoryJdbcOracleSelectString(sqlClient)
}

class UserRepositoryJdbcOracleSelectString(sqlClient: CoroutinesVertxSqlClient) :
    CoroutinesSelectStringRepository<OracleRoles, OracleUsers, OracleUserRoles>(
        sqlClient,
        OracleRoles,
        OracleUsers,
        OracleUserRoles
