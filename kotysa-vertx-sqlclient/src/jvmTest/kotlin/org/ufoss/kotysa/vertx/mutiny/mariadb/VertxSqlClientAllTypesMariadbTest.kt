...
class VertxSqlClientAllTypesMariadbTest : AbstractVertxSqlClientMariadbTest<AllTypesRepositoryMariadb>() {
    ...
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = AllTypesRepositoryMariadb(sqlClient)
...
class AllTypesRepositoryMariadb(private val sqlClient: MutinySqlClient) : Repository {
    ...
    private fun createTables() =
        (sqlClient createTableIfNotExists MariadbAllTypesNotNulls)
            .chain { -> sqlClient createTableIfNotExists MariadbAllTypesNullables }
