...
class VertxSqlClientUpdateDeleteMariadbTest :
    AbstractVertxSqlClientMariadbTest<UserRepositoryMariadbUpdateDelete>() {

    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = UserRepositoryMariadbUpdateDelete(sqlClient)
...
class UserRepositoryMariadbUpdateDelete(sqlClient: MutinyVertxSqlClient) : AbstractUserRepositoryMariadb(sqlClient) {
