...
class VertxSqlClientSelectOrMariadbTest : AbstractVertxSqlClientMariadbTest<UserRepositoryMariadbSelectOr>() {
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryMariadbSelectOr(sqlClient)
...
class UserRepositoryMariadbSelectOr(sqlClient: VertxSqlClient) : AbstractUserRepositoryMariadb(sqlClient) {
