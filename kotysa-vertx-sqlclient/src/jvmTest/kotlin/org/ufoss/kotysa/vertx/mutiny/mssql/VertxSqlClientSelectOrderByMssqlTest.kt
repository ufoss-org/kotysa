...
class VertxSqlClientSelectOrderByMssqlTest :
    ...
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = OrderByRepositoryMssqlSelect(sqlClient)
...
class OrderByRepositoryMssqlSelect(sqlClient: MutinyVertxSqlClient) : org.ufoss.kotysa.vertx.mutiny.mssql.AbstractCustomerRepositoryMssql(sqlClient) {
