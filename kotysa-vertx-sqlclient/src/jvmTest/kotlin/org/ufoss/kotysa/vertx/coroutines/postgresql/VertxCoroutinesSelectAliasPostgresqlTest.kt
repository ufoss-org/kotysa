...
class VertxCoroutinesSelectAliasPostgresqlTest : AbstractVertxCoroutinesPostgresqlTest<UserRepositorySelectAlias>() {
    ...
    @Test
    fun `Verify selectAliasedFirstnameByFirstnameAlias throws JdbcVertxCoroutinesBadGrammarException`() {
        assertThatThrownBy {
            runTest {
    ...
    @Test
    fun `Verify selectCaseWhenExistsSubQueryAlias throws JdbcVertxCoroutinesBadGrammarException`() {
        assertThatThrownBy {
            runTest {
    ...
    @Test
    fun `Verify selectRoleLabelWhereInUserSubQueryAlias throws JdbcVertxCoroutinesBadGrammarException`() {
        assertThatThrownBy {
            runTest {
