...
class VertxSqlClientSelectByteArrayMariadbTest :
    ...
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = ByteArrayRepositoryMariadbSelect(sqlClient)
...
class ByteArrayRepositoryMariadbSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MariadbByteArrays
