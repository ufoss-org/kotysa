...
class VertxSqlClientSelectLimitOffsetMssqlTest :
    ...
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = LimitOffsetRepositoryMssqlSelect(sqlClient)
...
class LimitOffsetRepositoryMssqlSelect(sqlClient: MutinyVertxSqlClient) :
    org.ufoss.kotysa.vertx.mutiny.mssql.AbstractCustomerRepositoryMssql(sqlClient) {
