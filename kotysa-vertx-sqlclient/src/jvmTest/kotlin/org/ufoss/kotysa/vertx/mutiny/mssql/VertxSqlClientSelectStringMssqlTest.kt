...
class VertxSqlClientSelectStringMssqlTest :
    AbstractVertxSqlClientMssqlTest<UserRepositoryMssqlSelectString>() {

    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = UserRepositoryMssqlSelectString(sqlClient)
...
class UserRepositoryMssqlSelectString(sqlClient: MutinyVertxSqlClient) : AbstractUserRepositoryMssql(sqlClient) {
