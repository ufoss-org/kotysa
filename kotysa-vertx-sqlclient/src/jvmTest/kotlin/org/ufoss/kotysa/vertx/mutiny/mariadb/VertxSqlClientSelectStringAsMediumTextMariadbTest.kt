...
class VertxSqlClientSelectStringAsMediumTextMariadbTest : AbstractVertxSqlClientMariadbTest<StringAsMediumTextRepositoryMariadbSelect>() {
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = StringAsMediumTextRepositoryMariadbSelect(sqlClient)
...
class StringAsMediumTextRepositoryMariadbSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MariadbMediumTexts
