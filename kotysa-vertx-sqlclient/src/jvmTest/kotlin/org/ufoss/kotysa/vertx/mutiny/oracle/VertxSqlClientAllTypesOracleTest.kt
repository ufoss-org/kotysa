...
class VertxSqlClientAllTypesOracleTest : AbstractVertxSqlClientOracleTest<AllTypesRepositoryOracle>() {
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = AllTypesRepositoryOracle(sqlClient)
...
class AllTypesRepositoryOracle(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() =
        (sqlClient createTableIfNotExists OracleAllTypesNotNulls)
            .chain { -> sqlClient createTableIfNotExists OracleAllTypesNullables }
