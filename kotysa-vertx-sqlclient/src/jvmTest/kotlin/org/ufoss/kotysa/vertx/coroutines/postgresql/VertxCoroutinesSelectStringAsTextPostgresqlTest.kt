...
class VertxCoroutinesSelectStringAsTextPostgresqlTest : AbstractVertxCoroutinesPostgresqlTest<StringAsTextRepositoryPostgresqlSelect>() {
    override fun instantiateRepository(sqlClient: PostgresqlCoroutinesVertxSqlClient) = StringAsTextRepositoryPostgresqlSelect(sqlClient)
...
class StringAsTextRepositoryPostgresqlSelect(private val sqlClient: CoroutinesVertxSqlClient) : Repository {
