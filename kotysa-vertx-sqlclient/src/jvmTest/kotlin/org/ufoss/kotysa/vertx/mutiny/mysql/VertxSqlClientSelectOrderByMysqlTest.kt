...
class VertxSqlClientSelectOrderByMysqlTest :
    ...
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = OrderByRepositoryMysqlSelect(sqlClient)
...
class OrderByRepositoryMysqlSelect(sqlClient: MutinyVertxSqlClient) : AbstractCustomerRepositoryMysql(sqlClient) {
