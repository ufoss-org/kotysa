...
interface MutinySelectStringAsMediumTextTest<T : MediumTexts, U : MutinySelectStringAsMediumTextRepository<T>>
    : MutinyRepositoryTest<U> {

    @Test
    fun `Verify selectFirstOrNullByStringNotNull finds stringAsMediumTextNotNull`() {
        assertThat(repository.selectFirstOrNullByStringNotNull(stringAsMediumTextNotNull.stringNotNull).await().indefinitely())
