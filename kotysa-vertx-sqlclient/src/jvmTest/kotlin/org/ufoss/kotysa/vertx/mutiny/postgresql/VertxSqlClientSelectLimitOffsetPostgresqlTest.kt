...
class VertxSqlClientSelectLimitOffsetPostgresqlTest :
    ...
    override fun instantiateRepository(sqlClient: PostgresqlMutinyVertxSqlClient) = LimitOffsetRepositoryPostgresqlSelect(sqlClient)
...
class LimitOffsetRepositoryPostgresqlSelect(sqlClient: MutinyVertxSqlClient) :
