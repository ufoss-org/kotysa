...
class VertxSqlClientSelectLocalDateMssqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = LocalDateRepositoryMssqlSelect(sqlClient)
...
class LocalDateRepositoryMssqlSelect(private val sqlClient: VertxSqlClient) : Repository {
