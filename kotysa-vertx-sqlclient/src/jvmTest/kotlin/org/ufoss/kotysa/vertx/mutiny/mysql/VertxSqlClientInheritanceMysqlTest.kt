...
class VertxSqlClientInheritanceMysqlTest :
    ...
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = InheritanceMysqlRepository(sqlClient)
...
class InheritanceMysqlRepository(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTable() = sqlClient createTableIfNotExists MysqlInheriteds
