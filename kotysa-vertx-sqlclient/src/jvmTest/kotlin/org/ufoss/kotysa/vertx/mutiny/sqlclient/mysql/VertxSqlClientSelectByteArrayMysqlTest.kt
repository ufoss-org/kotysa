...
class VertxSqlClientSelectByteArrayMysqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = ByteArrayRepositoryMysqlSelect(sqlClient)
...
class ByteArrayRepositoryMysqlSelect(private val sqlClient: VertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MysqlByteArrays
