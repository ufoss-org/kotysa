...
class VertxSqlClientSelectOrMysqlTest : AbstractVertxSqlClientMysqlTest<UserRepositoryMysqlSelectOr>() {
    ...
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = UserRepositoryMysqlSelectOr(sqlClient)
...
class UserRepositoryMysqlSelectOr(sqlClient: MutinyVertxSqlClient) : AbstractUserRepositoryMysql(sqlClient) {
