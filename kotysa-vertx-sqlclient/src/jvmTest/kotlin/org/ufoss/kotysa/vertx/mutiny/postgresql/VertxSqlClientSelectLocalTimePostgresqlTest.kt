...
class VertxSqlClientSelectLocalTimePostgresqlTest :
    ...
    override fun instantiateRepository(sqlClient: PostgresqlMutinyVertxSqlClient) = LocalTimeRepositoryPostgresqlSelect(sqlClient)
...
class LocalTimeRepositoryPostgresqlSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists PostgresqlLocalTimes
