...
interface MutinySelectIntAsIdentitiesTest<T : IntAsIdentities, U : MutinySelectIntAsIdentitiesRepository<T>> :
    ...
    private val intAsIdentityWithNullable get() = repository.generatedIntAsIdentitiesWithNullable
    private val intAsIdentityWithoutNullable get() = repository.generatedIntAsIdentitiesWithoutNullable
