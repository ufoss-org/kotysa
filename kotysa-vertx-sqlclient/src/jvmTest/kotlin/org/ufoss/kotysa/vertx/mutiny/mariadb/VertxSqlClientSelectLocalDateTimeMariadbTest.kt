...
class VertxSqlClientSelectLocalDateTimeMariadbTest :
    AbstractVertxSqlClientMariadbTest<LocalDateTimeRepositoryMariadbSelect>() {

    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = LocalDateTimeRepositoryMariadbSelect(sqlClient)
...
class LocalDateTimeRepositoryMariadbSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MariadbLocalDateTimes
