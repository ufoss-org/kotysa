...
class VertxSqlClientSelectStringAsLongTextMariadbTest : AbstractVertxSqlClientMariadbTest<StringAsLongTextRepositoryMariadbSelect>() {
    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = StringAsLongTextRepositoryMariadbSelect(sqlClient)
...
class StringAsLongTextRepositoryMariadbSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MariadbLongTexts
