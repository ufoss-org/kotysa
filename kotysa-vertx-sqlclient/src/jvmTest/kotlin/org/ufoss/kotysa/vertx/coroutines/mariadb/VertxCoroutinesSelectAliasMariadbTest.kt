...
class VertxCoroutinesSelectAliasMariadbTest : AbstractVertxCoroutinesMariadbTest<UserRepositorySelectAlias>() {
    override fun instantiateRepository(sqlClient: CoroutinesVertxSqlClient) = UserRepositorySelectAlias(sqlClient)

    @Test
    fun `Verify selectAliasedFirstnameByFirstnameGet throws MySQLException`() {
        assertThatThrownBy {
            runTest {
    ...
    @Test
    fun `Verify selectAliasedFirstnameByFirstnameAlias throws JdbcMySQLException`() {
        assertThatThrownBy {
            runTest {
    ...
    @Test
    fun `Verify selectCaseWhenExistsSubQueryAlias throws JdbcMySQLException`() {
        assertThatThrownBy {
            runTest {
    ...
    @Test
    fun `Verify selectRoleLabelWhereInUserSubQueryAlias throws JdbcMySQLException`() {
        assertThatThrownBy {
            runTest {
