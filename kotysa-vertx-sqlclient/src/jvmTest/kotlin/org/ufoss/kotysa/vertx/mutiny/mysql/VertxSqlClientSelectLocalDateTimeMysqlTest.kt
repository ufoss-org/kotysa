...
class VertxSqlClientSelectLocalDateTimeMysqlTest :
    AbstractVertxSqlClientMysqlTest<LocalDateTimeRepositoryMysqlSelect>() {

    override fun instantiateRepository(sqlClient: MutinyVertxSqlClient) = LocalDateTimeRepositoryMysqlSelect(sqlClient)
...
class LocalDateTimeRepositoryMysqlSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists MysqlLocalDateTimes
