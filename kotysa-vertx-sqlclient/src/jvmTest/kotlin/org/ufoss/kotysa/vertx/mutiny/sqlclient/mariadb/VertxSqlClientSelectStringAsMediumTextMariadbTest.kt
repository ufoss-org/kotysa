...
class VertxSqlClientSelectStringAsMediumTextMariadbTest : AbstractVertxSqlClientMariadbTest<StringAsMediumTextRepositoryMariadbSelect>() {
    override fun instantiateRepository(sqlClient: VertxSqlClient) = StringAsMediumTextRepositoryMariadbSelect(sqlClient)
...
class StringAsMediumTextRepositoryMariadbSelect(private val sqlClient: VertxSqlClient) : Repository {
