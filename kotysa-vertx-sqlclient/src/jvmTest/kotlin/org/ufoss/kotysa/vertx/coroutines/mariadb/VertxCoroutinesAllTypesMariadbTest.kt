...
class VertxCoroutinesAllTypesMariadbTest : AbstractVertxCoroutinesMariadbTest<AllTypesRepositoryMariadb>() {
    override fun instantiateRepository(sqlClient: CoroutinesVertxSqlClient) = AllTypesRepositoryMariadb(sqlClient)
...
class AllTypesRepositoryMariadb(private val sqlClient: CoroutinesVertxSqlClient) : Repository {
