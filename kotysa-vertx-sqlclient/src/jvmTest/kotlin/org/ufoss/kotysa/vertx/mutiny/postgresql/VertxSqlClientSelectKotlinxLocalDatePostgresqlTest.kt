...
class KotlinxLocalDateRepositoryPostgresqlSelect(private val sqlClient: MutinyVertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTableIfNotExists PostgresqlKotlinxLocalDates
