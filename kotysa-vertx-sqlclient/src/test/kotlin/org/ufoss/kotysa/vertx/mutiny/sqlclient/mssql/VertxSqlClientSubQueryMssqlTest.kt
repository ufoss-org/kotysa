...
class VertxSqlClientSubQueryMssqlTest :
    AbstractVertxSqlClientMssqlTest<UserRepositoryJdbcMssqlSubQuery>() {

    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryJdbcMssqlSubQuery(sqlClient)
...
class UserRepositoryJdbcMssqlSubQuery(sqlClient: VertxSqlClient) : AbstractUserRepositoryMssql(sqlClient) {
