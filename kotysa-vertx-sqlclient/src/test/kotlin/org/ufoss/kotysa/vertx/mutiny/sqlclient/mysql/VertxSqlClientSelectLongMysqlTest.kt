...
@Order(2)
class VertxSqlClientSelectLongMysqlTest : AbstractVertxSqlClientMysqlTest<LongRepositoryMysqlSelect>() {

    override fun instantiateRepository(sqlClient: VertxSqlClient) = LongRepositoryMysqlSelect(sqlClient)
...
class LongRepositoryMysqlSelect(private val sqlClient: VertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MysqlLongs
