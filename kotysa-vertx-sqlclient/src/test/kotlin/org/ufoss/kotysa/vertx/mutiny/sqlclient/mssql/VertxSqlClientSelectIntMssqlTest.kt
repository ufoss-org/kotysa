...
@Order(1)
class VertxSqlClientSelectIntMssqlTest : AbstractVertxSqlClientMssqlTest<IntRepositoryMssqlSelect>() {

    override fun instantiateRepository(sqlClient: VertxSqlClient) = IntRepositoryMssqlSelect(sqlClient)
...
class IntRepositoryMssqlSelect(private val sqlClient: VertxSqlClient) : Repository {
