...
class UserRepositoryMariadbSelectStringAsText(private val sqlClient: VertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MariadbTexts
