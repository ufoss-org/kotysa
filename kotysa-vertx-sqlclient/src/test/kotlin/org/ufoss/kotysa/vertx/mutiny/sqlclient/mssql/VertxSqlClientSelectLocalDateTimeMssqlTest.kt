...
class VertxSqlClientSelectLocalDateTimeMssqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = LocalDateTimeRepositoryMssqlSelect(sqlClient)
...
class LocalDateTimeRepositoryMssqlSelect(private val sqlClient: VertxSqlClient) : Repository {
