...
class VertxSqlClientUpdateDeleteMysqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryMysqlUpdateDelete(sqlClient)
...
class UserRepositoryMysqlUpdateDelete(sqlClient: VertxSqlClient) : AbstractUserRepositoryMysql(sqlClient) {
