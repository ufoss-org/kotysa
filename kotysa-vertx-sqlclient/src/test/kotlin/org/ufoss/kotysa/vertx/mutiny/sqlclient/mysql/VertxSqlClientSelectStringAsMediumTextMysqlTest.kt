...
class VertxSqlClientSelectStringAsMediumTextMysqlTest : AbstractVertxSqlClientMysqlTest<StringAsMediumTextRepositoryMysqlSelect>() {
    override fun instantiateRepository(sqlClient: VertxSqlClient) = StringAsMediumTextRepositoryMysqlSelect(sqlClient)
...
class StringAsMediumTextRepositoryMysqlSelect(private val sqlClient: VertxSqlClient) : Repository {
