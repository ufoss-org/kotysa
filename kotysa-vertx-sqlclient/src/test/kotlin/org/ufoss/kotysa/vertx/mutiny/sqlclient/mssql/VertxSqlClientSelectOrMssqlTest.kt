...
class VertxSqlClientSelectOrMssqlTest : AbstractVertxSqlClientMssqlTest<UserRepositoryMssqlSelectOr>() {
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryMssqlSelectOr(sqlClient)
...
class UserRepositoryMssqlSelectOr(sqlClient: VertxSqlClient) : AbstractUserRepositoryMssql(sqlClient) {
