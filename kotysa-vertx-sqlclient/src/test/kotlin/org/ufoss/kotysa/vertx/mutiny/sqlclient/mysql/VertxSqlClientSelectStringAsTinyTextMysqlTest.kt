...
class VertxSqlClientSelectStringAsTinyTextMysqlTest : AbstractVertxSqlClientMysqlTest<StringAsTinyTextRepositoryMysqlSelect>() {
    override fun instantiateRepository(sqlClient: VertxSqlClient) = StringAsTinyTextRepositoryMysqlSelect(sqlClient)
...
class StringAsTinyTextRepositoryMysqlSelect(private val sqlClient: VertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MysqlTinyTexts
