...
class VertxSqlClientSelectLocalDateTimeMysqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = LocalDateTimeRepositoryMysqlSelect(sqlClient)
...
class LocalDateTimeRepositoryMysqlSelect(private val sqlClient: VertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MysqlLocalDateTimes
