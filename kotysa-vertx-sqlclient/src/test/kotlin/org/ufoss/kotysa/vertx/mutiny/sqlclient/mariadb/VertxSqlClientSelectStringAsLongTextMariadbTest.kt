...
class VertxSqlClientSelectStringAsLongTextMariadbTest : AbstractVertxSqlClientMariadbTest<StringAsLongTextRepositoryMariadbSelect>() {
    override fun instantiateRepository(sqlClient: VertxSqlClient) = StringAsLongTextRepositoryMariadbSelect(sqlClient)
...
class StringAsLongTextRepositoryMariadbSelect(private val sqlClient: VertxSqlClient) : Repository {
