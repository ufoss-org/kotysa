...
class VertxSqlClientSelectLocalDateMysqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = LocalDateRepositoryMysqlSelect(sqlClient)
...
class LocalDateRepositoryMysqlSelect(private val sqlClient: VertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MysqlLocalDates
