...
class VertxSqlClientSelectLocalDateMariadbTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = LocalDateRepositoryMariadbSelect(sqlClient)
...
class LocalDateRepositoryMariadbSelect(private val sqlClient: VertxSqlClient) : Repository {
