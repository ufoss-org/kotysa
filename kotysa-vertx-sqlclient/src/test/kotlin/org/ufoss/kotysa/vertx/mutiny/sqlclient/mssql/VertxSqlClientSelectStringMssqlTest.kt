...
class VertxSqlClientSelectStringMssqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryMssqlSelectString(sqlClient)
...
class UserRepositoryMssqlSelectString(sqlClient: VertxSqlClient) : AbstractUserRepositoryMssql(sqlClient) {
