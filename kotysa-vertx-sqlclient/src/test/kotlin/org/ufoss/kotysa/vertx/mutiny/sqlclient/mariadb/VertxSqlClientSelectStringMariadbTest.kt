...
class VertxSqlClientSelectStringMariadbTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = UserRepositoryMariadbSelectString(sqlClient)
...
class UserRepositoryMariadbSelectString(sqlClient: VertxSqlClient) : AbstractUserRepositoryMariadb(sqlClient) {
