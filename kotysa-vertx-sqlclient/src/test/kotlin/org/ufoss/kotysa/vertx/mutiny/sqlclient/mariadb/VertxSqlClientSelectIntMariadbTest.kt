...
@Order(1)
class VertxSqlClientSelectIntMariadbTest : AbstractVertxSqlClientMariadbTest<IntRepositoryMariadbSelect>() {

    override fun instantiateRepository(sqlClient: VertxSqlClient) = IntRepositoryMariadbSelect(sqlClient)
...
class IntRepositoryMariadbSelect(private val sqlClient: VertxSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MariadbInts
