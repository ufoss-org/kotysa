...
class VertxSqlClientSelectLimitOffsetMysqlTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = LimitOffsetRepositoryMysqlSelect(sqlClient)
...
class LimitOffsetRepositoryMysqlSelect(sqlClient: VertxSqlClient) :
