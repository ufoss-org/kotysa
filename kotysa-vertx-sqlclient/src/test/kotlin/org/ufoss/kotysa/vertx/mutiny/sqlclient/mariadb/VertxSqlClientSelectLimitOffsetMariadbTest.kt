...
class VertxSqlClientSelectLimitOffsetMariadbTest :
    ...
    override fun instantiateRepository(sqlClient: VertxSqlClient) = LimitOffsetRepositoryMariadbSelect(sqlClient)
...
class LimitOffsetRepositoryMariadbSelect(sqlClient: VertxSqlClient) :
