...
class R2DbcSelectAndMssqlTest : AbstractR2dbcMssqlTest<ReactorUserRepositoryMssqlSelectAnd>(),
    ReactorSelectAndTest<MssqlRoles, MssqlUsers, MssqlUserRoles, ReactorUserRepositoryMssqlSelectAnd,
            ReactorTransaction> {
...
class ReactorUserRepositoryMssqlSelectAnd(sqlClient: ReactorSqlClient) :
    ReactorSelectAndRepository<MssqlRoles, MssqlUsers, MssqlUserRoles>(
        sqlClient,
        MssqlRoles,
        MssqlUsers,
        MssqlUserRoles
