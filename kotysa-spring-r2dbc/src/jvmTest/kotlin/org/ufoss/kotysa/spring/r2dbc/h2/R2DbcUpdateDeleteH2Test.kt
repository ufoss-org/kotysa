...
class R2dbcUpdateDeleteH2Test : AbstractR2dbcH2Test<UserRepositoryR2dbcH2UpdateDelete>(),
    ReactorUpdateDeleteTest<H2Roles, H2Users, H2UserRoles, H2Companies, UserRepositoryR2dbcH2UpdateDelete,
            ReactorTransaction> {
...
class UserRepositoryR2dbcH2UpdateDelete(sqlClient: ReactorSqlClient) :
    ReactorUpdateDeleteRepository<H2Roles, H2Users, H2UserRoles, H2Companies>(
        sqlClient,
        H2Roles,
        H2Users,
        H2UserRoles,
