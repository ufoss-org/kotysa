...
class R2dbcUpdateDeleteMariadbTest : AbstractR2dbcMariadbTest<UserRepositoryR2dbcMariadbUpdateDelete>(),
    ReactorUpdateDeleteTest<MariadbRoles, MariadbUsers, MariadbUserRoles, MariadbCompanies,
            UserRepositoryR2dbcMariadbUpdateDelete, ReactorTransaction> {
...
class UserRepositoryR2dbcMariadbUpdateDelete(sqlClient: ReactorSqlClient) :
    ReactorUpdateDeleteRepository<MariadbRoles, MariadbUsers, MariadbUserRoles, MariadbCompanies>(
        sqlClient,
        MariadbRoles,
        MariadbUsers,
        MariadbUserRoles,
