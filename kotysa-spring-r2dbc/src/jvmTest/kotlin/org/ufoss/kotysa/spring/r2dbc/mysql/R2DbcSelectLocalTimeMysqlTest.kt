...
class LocalTimeRepositoryMysqlSelect(private val sqlClient: MysqlReactorSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MysqlLocalTimes
