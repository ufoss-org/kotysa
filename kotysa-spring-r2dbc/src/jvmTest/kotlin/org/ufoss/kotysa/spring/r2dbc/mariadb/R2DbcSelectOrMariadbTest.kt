...
class R2dbcSelectOrMariadbTest : AbstractR2dbcMariadbTest<UserRepositoryR2dbcMariadbSelectOr>(),
    ReactorSelectOrTest<MariadbRoles, MariadbUsers, MariadbUserRoles, MariadbCompanies,
            UserRepositoryR2dbcMariadbSelectOr, ReactorTransaction> {
...
class UserRepositoryR2dbcMariadbSelectOr(sqlClient: ReactorSqlClient) :
    ReactorSelectOrRepository<MariadbRoles, MariadbUsers, MariadbUserRoles, MariadbCompanies>(
        sqlClient,
        MariadbRoles,
        MariadbUsers,
        MariadbUserRoles,
