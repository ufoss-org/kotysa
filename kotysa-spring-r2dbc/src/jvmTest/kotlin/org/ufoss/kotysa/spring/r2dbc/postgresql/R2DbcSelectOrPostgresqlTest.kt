...
class R2dbcSelectOrPostgresqlTest : AbstractR2dbcPostgresqlTest<UserRepositoryR2dbcPostgresqlSelectOr>(),
    ReactorSelectOrTest<PostgresqlRoles, PostgresqlUsers, PostgresqlUserRoles, PostgresqlCompanies,
            UserRepositoryR2dbcPostgresqlSelectOr, ReactorTransaction> {
...
class UserRepositoryR2dbcPostgresqlSelectOr(sqlClient: ReactorSqlClient) :
    ReactorSelectOrRepository<PostgresqlRoles, PostgresqlUsers, PostgresqlUserRoles, PostgresqlCompanies>(
        sqlClient,
        PostgresqlRoles,
        PostgresqlUsers,
        PostgresqlUserRoles,
