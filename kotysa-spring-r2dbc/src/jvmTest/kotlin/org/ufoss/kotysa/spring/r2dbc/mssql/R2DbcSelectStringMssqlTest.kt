...
class R2dbcSelectStringMssqlTest : AbstractR2dbcMssqlTest<UserRepositoryR2dbcMssqlSelectString>(),
    ReactorSelectStringTest<MssqlRoles, MssqlUsers, MssqlUserRoles, MssqlCompanies,
            UserRepositoryR2dbcMssqlSelectString, ReactorTransaction> {
...
class UserRepositoryR2dbcMssqlSelectString(sqlClient: ReactorSqlClient) :
    ReactorSelectStringRepository<MssqlRoles, MssqlUsers, MssqlUserRoles, MssqlCompanies>(
        sqlClient,
        MssqlRoles,
        MssqlUsers,
        MssqlUserRoles,
