...
class R2DbcSelectAndH2Test : AbstractR2dbcH2Test<ReactorUserRepositoryH2SelectAnd>(),
    ReactorSelectAndTest<H2Roles, H2Users, H2UserRoles, H2Companies, ReactorUserRepositoryH2SelectAnd,
            ReactorTransaction> {
...
class ReactorUserRepositoryH2SelectAnd(sqlClient: ReactorSqlClient) :
    ReactorSelectAndRepository<H2Roles, H2Users, H2UserRoles, H2Companies>(
        sqlClient,
        H2Roles,
        H2Users,
        H2UserRoles,
