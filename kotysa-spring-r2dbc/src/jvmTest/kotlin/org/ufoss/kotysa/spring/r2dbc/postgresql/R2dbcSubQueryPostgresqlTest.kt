...
class R2dbcSubQueryPostgresqlTest : AbstractR2dbcPostgresqlTest<UserRepositoryR2dbcPostgresqlSubQuery>(),
    ReactorSubQueryTest<PostgresqlRoles, PostgresqlUsers, PostgresqlUserRoles, UserRepositoryR2dbcPostgresqlSubQuery,
            ReactorTransaction> {
...
class UserRepositoryR2dbcPostgresqlSubQuery(sqlClient: ReactorSqlClient) :
    ReactorSubQueryRepository<PostgresqlRoles, PostgresqlUsers, PostgresqlUserRoles>(
        sqlClient,
        PostgresqlRoles,
        PostgresqlUsers,
        PostgresqlUserRoles
