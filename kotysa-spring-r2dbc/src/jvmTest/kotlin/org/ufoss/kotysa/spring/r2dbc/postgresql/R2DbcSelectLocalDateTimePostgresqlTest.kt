...
class R2DbcSelectLocalDateTimePostgresqlTest : AbstractR2dbcPostgresqlTest<LocalDateTimeRepositoryPostgresqlSelect>() {
    ...
    ) = LocalDateTimeRepositoryPostgresqlSelect(sqlClient)
...
class LocalDateTimeRepositoryPostgresqlSelect(private val sqlClient: PostgresqlReactorSqlClient) : Repository {
