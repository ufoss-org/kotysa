...
class R2dbcUpdateDeleteMysqlTest : AbstractR2dbcMysqlTest<UserRepositoryR2dbcMysqlUpdateDelete>(),
    ReactorUpdateDeleteTest<MysqlRoles, MysqlUsers, MysqlUserRoles, MysqlCompanies,
            UserRepositoryR2dbcMysqlUpdateDelete, ReactorTransaction> {
...
class UserRepositoryR2dbcMysqlUpdateDelete(sqlClient: ReactorSqlClient) :
    ReactorUpdateDeleteRepository<MysqlRoles, MysqlUsers, MysqlUserRoles, MysqlCompanies>(
        sqlClient,
        MysqlRoles,
        MysqlUsers,
        MysqlUserRoles,
