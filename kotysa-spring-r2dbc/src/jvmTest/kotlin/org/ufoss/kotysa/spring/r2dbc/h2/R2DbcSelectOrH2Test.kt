...
class R2dbcSelectOrH2Test : AbstractR2dbcH2Test<UserRepositoryR2dbcH2SelectOr>(),
    ReactorSelectOrTest<H2Roles, H2Users, H2UserRoles, H2Companies, UserRepositoryR2dbcH2SelectOr,
            ReactorTransaction> {
...
class UserRepositoryR2dbcH2SelectOr(sqlClient: ReactorSqlClient) :
    ReactorSelectOrRepository<H2Roles, H2Users, H2UserRoles, H2Companies>(
        sqlClient,
        H2Roles,
        H2Users,
        H2UserRoles,
