...
class R2dbcSubQueryH2Test : AbstractR2dbcH2Test<UserRepositoryR2dbcH2SubQuery>(),
    ReactorSubQueryTest<H2Roles, H2Users, H2UserRoles, H2Companies, UserRepositoryR2dbcH2SubQuery,
            ReactorTransaction> {
...
class UserRepositoryR2dbcH2SubQuery(sqlClient: ReactorSqlClient) :
    ReactorSubQueryRepository<H2Roles, H2Users, H2UserRoles, H2Companies>(
        sqlClient,
        H2Roles,
        H2Users,
        H2UserRoles,
