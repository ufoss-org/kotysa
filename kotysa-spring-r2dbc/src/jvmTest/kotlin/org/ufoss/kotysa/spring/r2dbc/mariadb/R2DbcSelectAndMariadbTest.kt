...
class R2DbcSelectAndMariadbTest : AbstractR2dbcMariadbTest<ReactorUserRepositoryMariadbSelectAnd>(),
    ReactorSelectAndTest<MariadbRoles, MariadbUsers, MariadbUserRoles, ReactorUserRepositoryMariadbSelectAnd,
            ReactorTransaction> {
...
class ReactorUserRepositoryMariadbSelectAnd(sqlClient: ReactorSqlClient) :
    ReactorSelectAndRepository<MariadbRoles, MariadbUsers, MariadbUserRoles>(
        sqlClient,
        MariadbRoles,
        MariadbUsers,
        MariadbUserRoles
