...
class R2dbcSelectOrMysqlTest : AbstractR2dbcMysqlTest<UserRepositoryR2dbcMysqlSelectOr>(),
    ReactorSelectOrTest<MysqlRoles, MysqlUsers, MysqlUserRoles, MysqlCompanies, UserRepositoryR2dbcMysqlSelectOr,
            ReactorTransaction> {
...
class UserRepositoryR2dbcMysqlSelectOr(sqlClient: ReactorSqlClient) :
    ReactorSelectOrRepository<MysqlRoles, MysqlUsers, MysqlUserRoles, MysqlCompanies>(
        sqlClient,
        MysqlRoles,
        MysqlUsers,
        MysqlUserRoles,
