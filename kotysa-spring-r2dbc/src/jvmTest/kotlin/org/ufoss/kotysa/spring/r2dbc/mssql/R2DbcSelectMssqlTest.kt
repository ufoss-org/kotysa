...
class R2DbcSelectMssqlTest : AbstractR2dbcMssqlTest<UserRepositoryMssqlSelect>(),
    ReactorSelectTest<MssqlRoles, MssqlUsers, MssqlUserRoles, MssqlCompanies, UserRepositoryMssqlSelect,
            ReactorTransaction> {
...
class UserRepositoryMssqlSelect(sqlClient: ReactorSqlClient) :
    ReactorSelectRepository<MssqlRoles, MssqlUsers, MssqlUserRoles, MssqlCompanies>(
        sqlClient,
        MssqlRoles,
        MssqlUsers,
        MssqlUserRoles,
