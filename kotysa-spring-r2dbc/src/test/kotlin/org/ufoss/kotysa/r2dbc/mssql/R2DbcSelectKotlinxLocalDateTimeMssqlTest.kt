...
class KotlinxLocalDateTimeRepositoryMssqlSelect(dbClient: DatabaseClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MSSQL_KOTLINX_LOCAL_DATE_TIME
