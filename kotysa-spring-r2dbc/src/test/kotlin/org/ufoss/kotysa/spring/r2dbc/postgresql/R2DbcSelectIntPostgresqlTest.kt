...
class R2DbcSelectIntPostgresqlTest : AbstractR2dbcPostgresqlTest<IntRepositoryPostgresqlSelect>() {
    ...
    ) = IntRepositoryPostgresqlSelect(sqlClient)
...
class IntRepositoryPostgresqlSelect(private val sqlClient: PostgresqlReactorSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable PostgresqlInts
