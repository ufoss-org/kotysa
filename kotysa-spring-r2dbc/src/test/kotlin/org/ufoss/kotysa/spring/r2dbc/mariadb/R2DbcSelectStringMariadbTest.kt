...
class R2DbcSelectStringMariadbTest : AbstractR2dbcMariadbTest<UserRepositoryMariadbSelectString>() {

    override fun instantiateRepository(sqlClient: MariadbReactorSqlClient, coSqlClient: MariadbCoroutinesSqlClient) =
        UserRepositoryMariadbSelectString(sqlClient)
...
class UserRepositoryMariadbSelectString(sqlClient: ReactorSqlClient) : AbstractUserRepositoryMariadb(sqlClient) {
