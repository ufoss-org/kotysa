...
class KotlinxLocalDateRepositoryMssqlSelect(private val sqlClient: MssqlReactorSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MssqlKotlinxLocalDates
