...
class ByteArrayRepositoryMssqlSelect(private val sqlClient: MssqlReactorSqlClient) : Repository {
    ...
    private fun createTables() = sqlClient createTable MssqlByteArrayAsBinaries
