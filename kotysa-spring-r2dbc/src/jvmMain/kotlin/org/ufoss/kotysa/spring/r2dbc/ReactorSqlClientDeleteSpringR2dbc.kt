...
internal class ReactorSqlClientDeleteSpringR2dbc private constructor() : AbstractSqlClientDeleteSpringR2dbc() {
    ...
    internal class FirstDelete<T : Any> internal constructor(
    ...
    ) : FirstDeleteOrUpdate<T, ReactorSqlClientDeleteOrUpdate.Where<T>>(DbAccessType.R2DBC, Module.SPRING_R2DBC),
        ...
        override fun <U : Any> innerJoin(
            table: Table<U>
        ): SqlClientQuery.Joinable<U, ReactorSqlClientDeleteOrUpdate.DeleteOrUpdate<U>> =
