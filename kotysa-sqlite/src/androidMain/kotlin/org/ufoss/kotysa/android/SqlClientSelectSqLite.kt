...
internal class SqlClientSelectSqLite private constructor() : DefaultSqlClientSelect() {
    ...
    private class Selects(
        ...
        override fun <T : Any> select(table: Table<T>): SqlClientSelect.SelectsPart2 = this.apply { addSelectTable(table) }
    ...
    private class FromTable<T : Any, U : Any>(
        ...
        SqlClientSelect.FromTable<T, U>, SqlClientSelect.From<T>,
        GroupableBy<T>,
        OrderableBy<T>,
    ...
    private class GroupByAndable<T : Any>(
        override val client: SQLiteDatabase,
        override val properties: Properties<T>
    ) : DefaultSqlClientSelect.GroupByAndable<T, SqlClientSelect.GroupBy<T>>, SqlClientSelect.GroupBy<T>,
