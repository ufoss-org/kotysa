...
class IntegerRepositorySelect(sqLiteOpenHelper: SQLiteOpenHelper, tables: Tables) : Repository {
    ...
    private fun insertIntegers() = sqlClient.insert(sqLiteIntegerWithNullable, sqLiteIntegerWithoutNullable)
    ...
    fun selectAllByIntegerNotNullNotEq(int: Int) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNotNull] notEq int }
            .fetchAll()

    fun selectAllByIntegerNotNullInf(int: Int) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNotNull] inf int }
            .fetchAll()

    fun selectAllByIntegerNotNullInfOrEq(int: Int) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNotNull] infOrEq int }
            .fetchAll()

    fun selectAllByIntegerNotNullSup(int: Int) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNotNull] sup int }
            .fetchAll()

    fun selectAllByIntegerNotNullSupOrEq(int: Int) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNotNull] supOrEq int }
            .fetchAll()

    fun selectAllByIntegerNullable(int: Int?) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNullable] eq int }
            .fetchAll()

    fun selectAllByIntegerNullableNotEq(int: Int?) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNullable] notEq int }
            .fetchAll()

    fun selectAllByIntegerNullableInf(int: Int) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNullable] inf int }
            .fetchAll()

    fun selectAllByIntegerNullableInfOrEq(int: Int) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNullable] infOrEq int }
            .fetchAll()

    fun selectAllByIntegerNullableSup(int: Int) = sqlClient.select<SqLiteInteger>()
            .where { it[SqLiteInteger::integerNullable] sup int }
            .fetchAll()

    fun selectAllByIntegerNullableSupOrEq(int: Int) = sqlClient.select<SqLiteInteger>()
