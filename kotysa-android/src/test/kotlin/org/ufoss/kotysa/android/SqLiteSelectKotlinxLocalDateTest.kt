...
import org.ufoss.kotysa.test.SqLiteKotlinxLocalDate
import org.ufoss.kotysa.test.sqLiteKotlinxLocalDateWithNullable
import org.ufoss.kotysa.test.sqLiteKotlinxLocalDateWithoutNullable
...
class KotlinxLocalDateRepositorySelect(sqLiteOpenHelper: SQLiteOpenHelper, tables: Tables) : Repository {
    ...
    private fun insertLocalDates() {
        sqlClient.insert(sqLiteKotlinxLocalDateWithNullable, sqLiteKotlinxLocalDateWithoutNullable)
    }
