...
import org.ufoss.kotysa.test.SqLiteLocalDate
import org.ufoss.kotysa.test.sqLiteLocalDateWithNullable
...
class SqLiteSelectLocalDateTest : AbstractSqLiteTest<LocalDateRepositorySelect>() {
    ...
    override fun getRepository(dbHelper: DbHelper, sqLiteTables: Tables) =
            LocalDateRepositorySelect(dbHelper, sqLiteTables)
...
class LocalDateRepositorySelect(sqLiteOpenHelper: SQLiteOpenHelper, tables: Tables) : Repository {
    ...
    private fun insertLocalDates() = sqlClient.insert(sqLiteLocalDateWithNullable, sqLiteLocalDateWithoutNullable)

    private fun deleteAll() = sqlClient.deleteAllFromTable<SqLiteLocalDate>()

    fun selectAllByLocalDateNotNull(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNotNull] eq localDate }
            .fetchAll()

    fun selectAllByLocalDateNotNullNotEq(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNotNull] notEq localDate }
            .fetchAll()

    fun selectAllByLocalDateNotNullBefore(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNotNull] before localDate }
            .fetchAll()

    fun selectAllByLocalDateNotNullBeforeOrEq(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNotNull] beforeOrEq localDate }
            .fetchAll()

    fun selectAllByLocalDateNotNullAfter(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNotNull] after localDate }
            .fetchAll()

    fun selectAllByLocalDateNotNullAfterOrEq(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNotNull] afterOrEq localDate }
            .fetchAll()

    fun selectAllByLocalDateNullable(localDate: LocalDate?) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNullable] eq localDate }
            .fetchAll()

    fun selectAllByLocalDateNullableNotEq(localDate: LocalDate?) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNullable] notEq localDate }
            .fetchAll()

    fun selectAllByLocalDateNullableBefore(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNullable] before localDate }
            .fetchAll()

    fun selectAllByLocalDateNullableBeforeOrEq(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNullable] beforeOrEq localDate }
            .fetchAll()

    fun selectAllByLocalDateNullableAfter(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
            .where { it[SqLiteLocalDate::localDateNullable] after localDate }
            .fetchAll()

    fun selectAllByLocalDateNullableAfterOrEq(localDate: LocalDate) = sqlClient.select<SqLiteLocalDate>()
