...
class R2dbcSelectStringH2Test : AbstractR2dbcH2Test<UserRepositoryJdbcH2SelectString>(),
    CoroutinesSelectStringTest<H2Roles, H2Users, H2UserRoles, UserRepositoryJdbcH2SelectString, R2dbcTransaction> {
...
class UserRepositoryJdbcH2SelectString(sqlClient: R2dbcSqlClient) :
    CoroutinesSelectStringRepository<H2Roles, H2Users, H2UserRoles>(sqlClient, H2Roles, H2Users, H2UserRoles)
