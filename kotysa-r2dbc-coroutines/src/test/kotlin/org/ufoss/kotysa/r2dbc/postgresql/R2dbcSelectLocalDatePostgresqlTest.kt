...
class R2dbcSelectLocalDatePostgresqlTest : AbstractR2dbcPostgresqlTest<LocalDateRepositoryPostgresqlSelect>(),
    CoroutinesSelectLocalDateTest<PostgresqlLocalDates, LocalDateRepositoryPostgresqlSelect, R2dbcTransaction> {
    override fun instantiateRepository(sqlClient: PostgresqlR2dbcSqlClient) =
        LocalDateRepositoryPostgresqlSelect(sqlClient)
}

class LocalDateRepositoryPostgresqlSelect(sqlClient: R2dbcSqlClient) :
