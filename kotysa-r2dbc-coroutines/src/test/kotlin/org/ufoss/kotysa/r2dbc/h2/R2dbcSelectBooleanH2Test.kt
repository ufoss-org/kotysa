...
class R2dbcSelectBooleanH2Test : AbstractR2dbcH2Test<UserRepositoryJdbcH2SelectBoolean>(),
    CoroutinesSelectBooleanTest<H2Roles, H2Users, H2UserRoles, UserRepositoryJdbcH2SelectBoolean, R2dbcTransaction> {
...
class UserRepositoryJdbcH2SelectBoolean(sqlClient: R2dbcSqlClient) :
    CoroutinesSelectBooleanRepository<H2Roles, H2Users, H2UserRoles>(sqlClient, H2Roles, H2Users, H2UserRoles)
