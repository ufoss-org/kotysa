...
public fun <T : Any> MariadbTable<T>.time(getter: (T) -> kotlinx.datetime.LocalTime, columnName: String? = null, precision: Int? = null): KotlinxLocalTimeDbTimeColumnNotNull<T> =
    KotlinxLocalTimeDbTimeColumnNotNull(getter, columnName, precision).also { addColumn(it) }

public fun <T : Any> MariadbTable<T>.time(getter: (T) -> kotlinx.datetime.LocalTime?, columnName: String? = null, defaultValue: kotlinx.datetime.LocalTime? = null, precision: Int? = null): KotlinxLocalTimeDbTimeColumnNullable<T> =
