...
public interface StringColumn<out T : Any> : Column<T, String>
...
public interface LocalDateTimeColumn<out T : Any> : Column<T, LocalDateTime>
...
public interface LocalDateColumn<out T : Any> : Column<T, LocalDate>
...
public interface OffsetDateTimeColumn<out T : Any> : Column<T, OffsetDateTime>
...
public interface LocalTimeColumn<out T : Any> : Column<T, LocalTime>
...
public interface IntColumn<out T : Any> : Column<T, Int>
