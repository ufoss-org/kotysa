...
interface ReactorSelectLocalDateTimeAsTimestampTest<T : LocalDateTimeAsTimestamps,
        U : ReactorSelectLocalDateTimeAsTimestampRepository<T>, V : Transaction> : ReactorRepositoryTest<U, V> {

    @Test
    fun `Verify selectAllByLocalDateTimeNotNull finds localDateTimeAsTimestampWithNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNull(java.time.LocalDateTime.of(2019, 11, 4, 0, 0))
                .toIterable()
        )
            .hasSize(1)
    ...
    fun `Verify selectAllByLocalDateTimeNotNullNotEq finds localDateTimeAsTimestampWithoutNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullNotEq(java.time.LocalDateTime.of(2019, 11, 4, 0, 0))
                .toIterable()
        )
            .hasSize(1)
    ...
    fun `Verify selectAllByLocalDateTimeNotNullBefore finds localDateTimeAsTimestampWithNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullBefore(java.time.LocalDateTime.of(2019, 11, 4, 12, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNotNullBefore finds no results when equals`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullBefore(java.time.LocalDateTime.of(2019, 11, 4, 0, 0))
                .toIterable()
        )
            .isEmpty()
    }
    ...
    fun `Verify selectAllByLocalDateTimeNotNullBeforeOrEq finds localDateTimeAsTimestampWithNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullBeforeOrEq(java.time.LocalDateTime.of(2019, 11, 4, 12, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNotNullBeforeOrEq finds localDateTimeAsTimestampWithNullable when equals`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullBeforeOrEq(java.time.LocalDateTime.of(2019, 11, 4, 0, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNotNullAfter finds localDateTimeAsTimestampWithoutNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullAfter(java.time.LocalDateTime.of(2019, 11, 5, 12, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithoutNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNotNullAfter finds no results when equals`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullAfter(java.time.LocalDateTime.of(2019, 11, 6, 0, 0))
                .toIterable()
        )
            .isEmpty()
    }
    ...
    fun `Verify selectAllByLocalDateTimeNotNullAfterOrEq finds localDateTimeAsTimestampWithoutNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullAfterOrEq(java.time.LocalDateTime.of(2019, 11, 5, 12, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithoutNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNotNullAfterOrEq finds localDateTimeAsTimestampWithoutNullable when equals`() {
        assertThat(
            repository.selectAllByLocalDateTimeNotNullAfterOrEq(java.time.LocalDateTime.of(2019, 11, 6, 0, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithoutNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNullable finds h2UuidWithNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullable(java.time.LocalDateTime.of(2018, 11, 4, 0, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNullableNotEq finds h2UuidWithoutNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullableNotEq(java.time.LocalDateTime.of(2018, 11, 4, 0, 0))
                .toIterable()
        )
            .isEmpty()
    }
    ...
    fun `Verify selectAllByLocalDateTimeNullableBefore finds localDateTimeAsTimestampWithNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullableBefore(java.time.LocalDateTime.of(2018, 11, 4, 12, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNullableBefore finds no results when equals`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullableBefore(java.time.LocalDateTime.of(2018, 11, 4, 0, 0))
                .toIterable()
        )
            .isEmpty()
    }
    ...
    fun `Verify selectAllByLocalDateTimeNullableBeforeOrEq finds localDateTimeAsTimestampWithNullable when equals`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullableBeforeOrEq(java.time.LocalDateTime.of(2018, 11, 4, 0, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNullableAfter finds localDateTimeAsTimestampWithoutNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullableAfter(java.time.LocalDateTime.of(2018, 11, 3, 12, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNullableAfter finds no results when equals`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullableAfter(java.time.LocalDateTime.of(2018, 11, 4, 0, 0))
                .toIterable()
        )
            .isEmpty()
    }
    ...
    fun `Verify selectAllByLocalDateTimeNullableAfterOrEq finds localDateTimeAsTimestampWithoutNullable`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullableAfterOrEq(java.time.LocalDateTime.of(2018, 11, 3, 12, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
    ...
    fun `Verify selectAllByLocalDateTimeNullableAfterOrEq finds localDateTimeAsTimestampWithoutNullable when equals`() {
        assertThat(
            repository.selectAllByLocalDateTimeNullableAfterOrEq(java.time.LocalDateTime.of(2018, 11, 4, 0, 0))
                .toIterable()
        )
            .hasSize(1)
            .containsExactlyInAnyOrder(localDateTimeAsTimestampWithNullable)
