...
interface SelectBigDecimalTest<T : BigDecimals, U : SelectBigDecimalRepository<T>, V : Transaction>
    : RepositoryTest<U, V> {

    @Test
    fun `Verify selectAllByBigDecimalNotNull finds bigDecimalWithNullable`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNotNull(bigDecimalWithNullable.bigDecimalNotNull))
            .hasSize(1)
    ...
    fun `Verify selectAllByBigDecimalNotNullNotEq finds bigDecimalWithoutNullable`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNotNullNotEq(bigDecimalWithNullable.bigDecimalNotNull))
            .hasSize(1)
    ...
    fun `Verify selectAllByBigDecimalNotNullInf finds no results when equals`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNotNullInf(bigDecimalWithNullable.bigDecimalNotNull))
            .isEmpty()
    }
    ...
    fun `Verify selectAllByBigDecimalNotNullInfOrEq finds bigDecimalWithNullable when equals`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNotNullInfOrEq(bigDecimalWithNullable.bigDecimalNotNull))
            .hasSize(1)
            .containsExactlyInAnyOrder(bigDecimalWithNullable)
    }
    ...
    fun `Verify selectAllByBigDecimalNotNullSup finds bigDecimalWithoutNullable`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNotNullSup(bigDecimalWithNullable.bigDecimalNotNull))
            .hasSize(1)
            .containsExactlyInAnyOrder(bigDecimalWithoutNullable)
    }
    ...
    fun `Verify selectAllByBigDecimalNotNullSup finds no results when equals`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNotNullSup(bigDecimalWithoutNullable.bigDecimalNotNull))
            .isEmpty()
    }
    ...
    fun `Verify selectAllByBigDecimalNotNullSupOrEq finds bigDecimalWithoutNullable when equals`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNotNullSupOrEq(bigDecimalWithoutNullable.bigDecimalNotNull))
            .hasSize(1)
            .containsExactlyInAnyOrder(bigDecimalWithoutNullable)
    }
    ...
    fun `Verify selectAllByBigDecimalNullable finds bigDecimalWithNullable`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNullable(bigDecimalWithNullable.bigDecimalNullable))
            .hasSize(1)
            .containsExactlyInAnyOrder(bigDecimalWithNullable)
    }
    ...
    fun `Verify selectAllByBigDecimalNullableNotEq finds nothing`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNullableNotEq(bigDecimalWithNullable.bigDecimalNullable))
            .isEmpty()
    }
    ...
    fun `Verify selectAllByBigDecimalNullableInf finds no results when equals`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNullableInf(bigDecimalWithNullable.bigDecimalNullable!!))
            .isEmpty()
    }
    ...
    fun `Verify selectAllByBigDecimalNullableInfOrEq finds bigDecimalWithNullable when equals`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNullableInfOrEq(bigDecimalWithNullable.bigDecimalNullable!!))
            .hasSize(1)
            .containsExactlyInAnyOrder(bigDecimalWithNullable)
    }
    ...
    fun `Verify selectAllByBigDecimalNullableSup finds no results when equals`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNullableSup(bigDecimalWithNullable.bigDecimalNullable!!))
            .isEmpty()
    }
    ...
    fun `Verify selectAllByBigDecimalNullableSupOrEq finds bigDecimalWithoutNullable when equals`() {
        Assertions.assertThat(repository.selectAllByBigDecimalNullableSupOrEq(bigDecimalWithNullable.bigDecimalNullable!!))
            .hasSize(1)
            .containsExactlyInAnyOrder(bigDecimalWithNullable)
    }
}