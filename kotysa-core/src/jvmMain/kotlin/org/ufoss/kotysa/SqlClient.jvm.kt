...
public actual class SqlClientSelect private actual constructor() : SqlClientQuery() {
    ...
    public actual interface FromsTable<T : Any, U : Any> : FromsPart2<T>, FromTableSelect<U> {
        actual override fun <V : Any> innerJoin(table: Table<V>): Joinable<V, FromsTable<T, V>>
        actual override fun <V : Any> leftJoin(table: Table<V>): Joinable<V, FromsTable<T, V>>
        actual override fun <V : Any> rightJoin(table: Table<V>): Joinable<V, FromsTable<T, V>>
        actual override fun <V : Any> fullJoin(table: Table<V>): Joinable<V, FromsTable<T, V>>
    }
    ...
    public actual interface From<T : Any> : SqlClientQuery.From, FromAndable, Whereable<T>, GroupableBy<T>, OrderableBy<T>,
        LimitOffset<T>, Return<T> {
    ...
    public actual interface FromTable<T : Any, U : Any> : FromTableSelect<U>, From<T>, Whereable<T>, GroupableBy<T>,
        ...
        actual override fun <V : Any> innerJoin(table: Table<V>): Joinable<V, FromTable<T, V>>
        actual override fun <V : Any> leftJoin(table: Table<V>): Joinable<V, FromTable<T, V>>
        actual override fun <V : Any> rightJoin(table: Table<V>): Joinable<V, FromTable<T, V>>
        actual override fun <V : Any> fullJoin(table: Table<V>): Joinable<V, FromTable<T, V>>
    }
    ...
    public actual interface GroupBy<T : Any> : SqlClientQuery.GroupBy<GroupBy<T>>,
        GroupByAndable<GroupBy<T>>, OrderableBy<T>, LimitOffset<T>, Return<T>
    ...
    public actual interface OrderBy<T : Any> : SqlClientQuery.OrderBy<OrderBy<T>>,
        OrderByAndable<OrderBy<T>>, GroupableBy<T>, LimitOffset<T>, Return<T>
...
public actual class SqlClientDeleteOrUpdate private actual constructor() : SqlClientQuery() {
    public actual interface FirstDeleteOrUpdate<T : Any> : FromTable<T>, Whereable<Where<T>>, Return {
        actual override fun <U : Any> innerJoin(table: Table<U>): Joinable<U, DeleteOrUpdate<U>>
    }
