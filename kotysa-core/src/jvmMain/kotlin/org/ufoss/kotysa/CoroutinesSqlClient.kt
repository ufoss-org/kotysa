...
public interface CoroutinesSqlClient {
    ...
    public suspend infix fun <T : Any> insertAndReturn(row: T): T
    public fun <T : Any> insertAndReturn(vararg rows: T): Flow<T>
    ...
    public infix fun <T : Any> selectAndBuild(dsl: (ValueProvider) -> T): CoroutinesSqlClientSelect.Fromable<T>
    ...
    public infix fun <T : Any, U : Any> selectSum(column: WholeNumberColumn<T, U>): CoroutinesSqlClientSelect.FirstSelect<Long>
    ...
    public fun selects(): CoroutinesSqlClientSelect.Selects
}
