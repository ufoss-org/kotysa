...
import org.ufoss.kotysa.test.MARIADB_KOTLINX_LOCAL_DATE_TIME
...
class KotlinxLocalDateTimeRepositoryMariadbSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun createTables() {
        sqlClient createTable MARIADB_KOTLINX_LOCAL_DATE_TIME
    }
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MARIADB_KOTLINX_LOCAL_DATE_TIME
