...
class R2dbcSelectLongMariadbTest : AbstractR2dbcMariadbTest<LongRepositoryMariadbSelect>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = LongRepositoryMariadbSelect(sqlClient)
...
class LongRepositoryMariadbSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MariadbLongs
