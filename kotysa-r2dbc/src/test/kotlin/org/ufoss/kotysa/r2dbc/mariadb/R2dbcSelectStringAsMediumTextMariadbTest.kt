...
class R2dbcSelectStringAsMediumTextMariadbTest : AbstractR2dbcMariadbTest<StringAsMediumTextRepositoryMariadbSelect>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = StringAsMediumTextRepositoryMariadbSelect(sqlClient)
...
class StringAsMediumTextRepositoryMariadbSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun createTables() {
        sqlClient createTable MariadbMediumTexts
    }
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MariadbMediumTexts
