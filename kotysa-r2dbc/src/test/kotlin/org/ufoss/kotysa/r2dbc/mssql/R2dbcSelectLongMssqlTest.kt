...
@Order(2)
class R2dbcSelectLongMssqlTest : AbstractR2dbcMssqlTest<LongRepositoryMssqlSelect>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = LongRepositoryMssqlSelect(sqlClient)
...
class LongRepositoryMssqlSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun createTables() {
        sqlClient createTable MssqlLongs
    }
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MssqlLongs
