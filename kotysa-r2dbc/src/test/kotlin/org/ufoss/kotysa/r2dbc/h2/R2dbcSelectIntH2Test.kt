...
class R2dbcSelectIntH2Test : AbstractR2dbcH2Test<IntRepositoryH2Select>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = IntRepositoryH2Select(sqlClient)
    ...
    @Test
    fun `Verify selectAllByIntNullable finds h2UuidWithNullable`() = runTest {
...
class IntRepositoryH2Select(private val sqlClient: R2dbcSqlClient) : Repository {
