...
class R2dbcSelectStringAsMediumTextMysqlTest : AbstractR2dbcMysqlTest<StringAsMediumTextRepositoryMysqlSelect>() {
    override fun instantiateRepository(connection: Connection) = StringAsMediumTextRepositoryMysqlSelect(connection)
...
class StringAsMediumTextRepositoryMysqlSelect(connection: Connection) : Repository {
    ...
    private suspend fun createTables() {
        sqlClient createTable MYSQL_MEDIUM_TEXT
    }
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MYSQL_MEDIUM_TEXT
