...
class R2dbcSelectStringMssqlTest : AbstractR2dbcMssqlTest<UserRepositoryJdbcMssqlSelectString>() {
    override fun instantiateRepository(connection: Connection) = UserRepositoryJdbcMssqlSelectString(connection)
...
class UserRepositoryJdbcMssqlSelectString(connection: Connection) : AbstractUserRepositoryR2dbcMssql(connection) {
