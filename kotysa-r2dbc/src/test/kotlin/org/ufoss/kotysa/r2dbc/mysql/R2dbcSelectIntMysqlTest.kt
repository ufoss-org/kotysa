...
class R2dbcSelectIntMysqlTest : AbstractR2dbcMysqlTest<IntRepositoryMysqlSelect>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = IntRepositoryMysqlSelect(sqlClient)
...
class IntRepositoryMysqlSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun createTables() {
        sqlClient createTable MysqlInts
    }
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MysqlInts
