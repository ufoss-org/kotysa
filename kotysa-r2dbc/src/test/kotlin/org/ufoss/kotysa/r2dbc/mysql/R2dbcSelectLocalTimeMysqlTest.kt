...
import org.ufoss.kotysa.test.MYSQL_LOCAL_TIME
...
class LocalTimeRepositoryMysqlSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MYSQL_LOCAL_TIME
