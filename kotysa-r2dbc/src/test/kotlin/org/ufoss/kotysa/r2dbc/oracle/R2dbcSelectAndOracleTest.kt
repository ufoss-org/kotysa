...
class R2dbcSelectAndOracleTest : AbstractR2dbcOracleTest<UserRepositoryJdbcOracleSelectAnd>(),
    CoroutinesSelectAndTest<OracleRoles, OracleUsers, OracleUserRoles, UserRepositoryJdbcOracleSelectAnd,
            R2dbcTransaction> {
...
class UserRepositoryJdbcOracleSelectAnd(sqlClient: R2dbcSqlClient) :
    CoroutinesSelectAndRepository<OracleRoles, OracleUsers, OracleUserRoles>(
        sqlClient,
        OracleRoles,
        OracleUsers,
        OracleUserRoles
