...
class R2dbcAllTypesOracleTest : AbstractR2dbcOracleTest<AllTypesRepositoryOracle>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = AllTypesRepositoryOracle(sqlClient)
...
class AllTypesRepositoryOracle(private val sqlClient: R2dbcSqlClient) : Repository {
