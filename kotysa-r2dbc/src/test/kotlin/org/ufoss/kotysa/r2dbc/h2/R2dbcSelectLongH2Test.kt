...
class R2dbcSelectLongH2Test : AbstractR2dbcH2Test<LongRepositoryH2Select>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = LongRepositoryH2Select(sqlClient)
...
class LongRepositoryH2Select(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom H2_LONG
