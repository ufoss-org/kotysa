...
import org.ufoss.kotysa.test.MARIADB_TEXT
import org.ufoss.kotysa.test.Repository
import org.ufoss.kotysa.test.stringAsTextNotNull
import org.ufoss.kotysa.test.stringAsTextNullable

class R2dbcSelectStringAsTextMariadbTest : AbstractR2dbcMariadbTest<StringAsTextRepositoryMariadbSelect>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = StringAsTextRepositoryMariadbSelect(sqlClient)
...
class StringAsTextRepositoryMariadbSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MARIADB_TEXT
