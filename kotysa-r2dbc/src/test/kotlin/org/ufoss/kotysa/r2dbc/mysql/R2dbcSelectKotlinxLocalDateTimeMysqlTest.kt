...
class R2dbcSelectKotlinxLocalDateTimeMysqlTest : AbstractR2dbcMysqlTest<KotlinxLocalDateTimeRepositoryMysqlSelect>() {
    override fun instantiateRepository(connection: Connection) = KotlinxLocalDateTimeRepositoryMysqlSelect(connection)
...
class KotlinxLocalDateTimeRepositoryMysqlSelect(connection: Connection) : Repository {
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MYSQL_KOTLINX_LOCAL_DATE_TIME
