...
class R2dbcSelectIntMssqlTest : AbstractR2dbcMssqlTest<IntRepositoryMssqlSelect>() {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = IntRepositoryMssqlSelect(sqlClient)
...
class IntRepositoryMssqlSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MssqlInts
