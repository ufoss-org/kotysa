...
import org.ufoss.kotysa.test.MARIADB_KOTLINX_LOCAL_DATE
...
class KotlinxLocalDateRepositoryMariadbSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MARIADB_KOTLINX_LOCAL_DATE
