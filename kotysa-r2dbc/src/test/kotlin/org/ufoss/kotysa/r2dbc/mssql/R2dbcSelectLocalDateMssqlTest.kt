...
class LocalDateRepositoryMssqlSelect(private val sqlClient: R2dbcSqlClient) : Repository {
    ...
    private suspend fun createTables() {
        sqlClient createTable MssqlLocalDates
    }
    ...
    private suspend fun deleteAll() = sqlClient deleteAllFrom MssqlLocalDates
