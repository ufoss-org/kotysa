...
class R2dbcSelectLimitOffsetPostgresqlTest : AbstractR2dbcPostgresqlTest<LimitOffsetRepositoryPostgresqlSelect>(),
    CoroutinesSelectLimitOffsetTest<PostgresqlCustomers, LimitOffsetRepositoryPostgresqlSelect, R2dbcTransaction> {
    override fun instantiateRepository(sqlClient: PostgresqlR2dbcSqlClient) =
        LimitOffsetRepositoryPostgresqlSelect(sqlClient)
}

class LimitOffsetRepositoryPostgresqlSelect(sqlClient: R2dbcSqlClient) :
