...
class R2dbcUpdateDeleteH2Test : AbstractR2dbcH2Test<UserRepositoryJdbcH2UpdateDelete>(),
    CoroutinesUpdateDeleteTest<H2Roles, H2Users, H2UserRoles, H2Companies, UserRepositoryJdbcH2UpdateDelete,
            R2dbcTransaction> {
...
class UserRepositoryJdbcH2UpdateDelete(sqlClient: R2dbcSqlClient) :
    CoroutinesUpdateDeleteRepository<H2Roles, H2Users, H2UserRoles, H2Companies>(
        sqlClient,
        H2Roles,
        H2Users,
        H2UserRoles,
