...
class R2dbcSelectOffsetDateTimeMssqlTest : AbstractR2dbcMssqlTest<OffsetDateTimeRepositoryMssqlSelect>(),
    CoroutinesSelectOffsetDateTimeTest<MssqlOffsetDateTimes, OffsetDateTimeRepositoryMssqlSelect, R2dbcTransaction> {
    override fun instantiateRepository(sqlClient: R2dbcSqlClient) = OffsetDateTimeRepositoryMssqlSelect(sqlClient)
}

class OffsetDateTimeRepositoryMssqlSelect(sqlClient: R2dbcSqlClient) :
