...
class R2dbcSubQueryH2Test : AbstractR2dbcH2Test<UserRepositoryR2dbcH2SubQuery>(),
    CoroutinesSubQueryTest<H2Roles, H2Users, H2UserRoles, H2Companies, UserRepositoryR2dbcH2SubQuery,
            R2dbcTransaction> {
...
class UserRepositoryR2dbcH2SubQuery(sqlClient: R2dbcSqlClient) :
    CoroutinesSubQueryRepository<H2Roles, H2Users, H2UserRoles, H2Companies>(
        sqlClient,
        H2Roles,
        H2Users,
        H2UserRoles,
